#!/bin/bash
#
#SBATCH --job-name=sm_freebayes_main_job
#SBATCH --ntasks=1
#SBATCH --nodes=1
...
################################################################################
# Usage:
#   sbatch submit_freebayes_pipeline.sh [SNAKEMAKE_FILE] [CONFIG_FILE] [MAX_JOBS]
#
#   - SNAKEMAKE_FILE:   Path to the Snakemake workflow file
#                       (default: "freebayes_germline_pipeline.smk")
...
# ------------------------------------------------------------------------------
SNAKEMAKE_FILE=${1:-"freebayes_germline_pipeline.smk"}
...
echo "DEBUG: Running FreeBayes pipeline with:"
